...
function App() {
  ...
  return (
    <ClerkProvider publishableKey={PUBLISHABLE_KEY} afterSignOutUrl="/expense-tracker-project" afterSignInUrl="/expense-tracker-project" afterSignUpUrl="/expense-tracker-project">
